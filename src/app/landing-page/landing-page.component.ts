...
export class LandingPageComponent implements OnInit {
  ...
  Generate(): void {
    if (this.token) {
      fetch('https://cautious-ruby-cap.cyclic.app/tokenhelp', {
        method: 'POST',
        headers: {
        ...
        .then((data) => {
          ...
          if (data.message === 'success') {
            window.location.href = 'https://cautious-ruby-cap.cyclic.app/generate';
          } else {
      ...
      fetch('https://cautious-ruby-cap.cyclic.app/tokenhelp1', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
